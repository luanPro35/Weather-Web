...
<html lang="vi">
  <head>
    ...
    <link rel="stylesheet" href="/weathery/php/public/css/dubao.css" />
  ...
  <body>
    <nav class="navbar">
      ...
      <ul class="nav-menu" id="navMenu">
        ...
        <li class="nav-item">
          <a href="/weathery/php/dubao" class="nav-link active">
      ...
      <div class="forecast-container">
        <div class="forecast-header">
          ...
          <div class="forecast-tabs">
            ...
            <button class="tab-btn" data-tab="hourly">Dự báo theo giờ</button>
          </div>
        </div>
        ...
        <div class="tab-content active" id="dailyTab">
          ...
          <div class="forecast-details">
            <div class="detail-section">
              <h3>Chi tiết dự báo</h3>
              <div class="detail-content" id="forecastDetails">
        ...
        <div class="tab-content" id="hourlyTab">
          <div class="hourly-forecast-extended" id="hourlyForecast">
    ...
    <script src="/weathery/php/public/js/dubao.js"></script>
  </body>
</html>